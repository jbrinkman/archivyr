...
- [ ] 3.1 Write unit tests for Valkey client
  - Test NewClient with mock connections
  - Test connection error scenarios
  - Test Ping functionality
  - _Requirements: 1.5, 9.4, 9.5_

- [ ] 4. Implement core ruleset data types and validation
...
- [ ] 5. Implement ruleset service - Create operation
...
- [ ] 5.1 Write unit tests for Create operation
  - Test successful creation
  - Test duplicate name detection and error response
  - Test timestamp setting
  - _Requirements: 2.1, 2.2, 2.3, 2.4, 2.5_

- [ ] 6. Implement ruleset service - Read operations
...
- [ ] 6.1 Write unit tests for Read operations
...
- [ ] 7. Implement ruleset service - Update operation
...
- [ ] 7.1 Write unit tests for Update operation
...
- [ ] 8. Implement ruleset service - Delete operation
...
- [ ] 10. Implement MCP tool handlers
...
- [ ] 10.1 Write unit tests for MCP tool handlers
  - Test each tool handler with valid inputs
  - Test error scenarios for each tool
  - Test parameter validation
  - _Requirements: 2.1, 3.1, 4.1, 5.1, 6.1, 7.1_

- [ ] 11. Implement MCP server initialization and stdio transport
...
- [ ] 13. Write integration tests for Valkey operations
...
- [ ] 14. Write integration tests for MCP protocol
...
- [ ] 15. Create Dockerfile with multi-stage build
...
- [ ] 16. Create Docker entrypoint script
...
- [ ] 17. Write end-to-end Docker tests
...
- [ ] 18. Create GitHub Actions CI workflow
...
- [ ] 19. Create GitHub Actions CD workflow
...
- [ ] 20. Create semantic-release configuration
...
- [ ] 21. Create golangci-lint configuration
